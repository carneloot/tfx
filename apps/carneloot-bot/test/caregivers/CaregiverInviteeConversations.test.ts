...
describe('invitee caregiver conversation declarations', () => {
	it.each([
		[PetInvitations.declaration, 'pet-caregiver-invitations', 'invitation', ['invitation', 'confirm']],
		[StopCaring.declaration, 'stop-caring-for-pet', 'pet', ['pet', 'confirm']],
	] as const)('declares durable %s version 1', (declaration, id, initialStep, steps) => {
