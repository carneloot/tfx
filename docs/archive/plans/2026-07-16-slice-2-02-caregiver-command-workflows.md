...
- [x] **Step 2: Define invitation result contracts**
...
- [x] **Step 3: Implement owner services**
...
- [x] **Step 4: Implement invitee services**
...
- [x] **Step 6: Commit application services**
...
- [x] **Step 1: Write failing deletion integration tests**
...
- [x] **Step 2: Extend persistence ports**
...
- [x] **Step 3: Run deletion integration tests**
...
- [x] **Step 4: Commit deletion service**
...
- [x] **Step 1: Make builder type test fail**
...
- [x] **Step 2: Extend `pets` declaration**
...
- [x] **Step 3: Bind exhaustive handlers**
...
- [x] **Step 4: Register conversations**
...
- [x] **Step 5: Run builder/router tests**
...
- [x] **Step 1: Write failing transcripts**
...
- [x] **Step 2: Implement typed choices**
...
- [x] **Step 3: Recheck protected reads**
...
- [x] **Step 4: Attach post-commit output**
...
- [x] **Step 5: Run owner conversation tests**
...
- [x] **Step 6: Commit owner workflows**
...
- [x] **Step 2: Implement invitation response machine**
...
- [x] **Step 3: Implement stop-caring machine**
...
- [x] **Step 4: Run invitee conversation tests**
...
- [x] **Step 5: Commit invitee workflows**
...
- [x] **Step 1: Add update-driven E2E fixture**
...
- [x] **Step 2: Add interrupted/concurrent cases**
