...
- [x] **Step 2: Add raw time syntax codec**
...
- [x] **Step 3: Refactor `AddFood` input**
...
- [x] **Step 4: Run parser/application tests**
...
- [x] **Step 5: Commit input refactor**
...
- [x] **Step 1: Write failing conversation source test**
...
- [x] **Step 2: Remove startup source from amount state**
...
- [x] **Step 3: Preserve post-commit output**
...
- [x] **Step 4: Run conversation tests**
...
- [x] **Step 1: Write failing shared-access tests**
...
- [x] **Step 2: Return role-aware list projections**
...
- [x] **Step 3: Generalize status and single-add choices**
...
- [x] **Step 4: Run shared-access tests**
...
- [x] **Step 1: Write failing tfx alias tests**
...
- [x] **Step 2: Add aliases to `Command.make`**
...
- [x] **Step 3: Validate, route, and publish aliases**
...
- [x] **Step 4: Add compile-time parser tests and one declaration**
...
- [x] **Step 5: Bind one exhaustive handler**
...
- [x] **Step 6: Run alias/declaration tests**
...
- [x] **Step 2: Define closed per-pet result**
...
- [x] **Step 1: Add end-to-end scenario**
...
- [x] **Step 2: Add replay and revocation scenario**
...
- [x] **Step 3: Run real-PostgreSQL tests**
...
- [x] **Step 4: Run package gate and commit**
