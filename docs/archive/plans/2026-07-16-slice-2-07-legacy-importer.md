...
- [x] **Step 2: Create target migration**
...
- [x] **Step 3: Generate/register artifact**
...
- [x] **Step 1: Write failing config/CLI tests**
...
- [x] **Step 2: Add pinned dependency/script**
...
- [x] **Step 3: Define separate config**
...
- [x] **Step 4: Implement read-only source port**
...
- [x] **Step 5: Verify source remains unchanged**
...
- [x] **Step 6: Run config/source tests**
...
- [x] **Step 2: Implement Effect schemas**
...
- [x] **Step 1: Write UUIDv5 test vectors**
...
- [x] **Step 2: Implement UUIDv5 through `effect/Crypto`**
...
- [x] **Step 3: Define source fingerprint**
...
- [x] **Step 4: Map identity/pet/caregiver rows**
...
- [x] **Step 5: Map food/settings rows**
...
- [x] **Step 6: Map keys/templates/subscriptions/history**
...
- [x] **Step 1: Write failing graph-verification tests**
...
- [x] **Step 3: Implement pre-promotion verification**
...
- [x] **Step 4: Write report atomically**
...
- [x] **Step 6: Commit verifier/report**
...
- [x] **Step 1: Write failing PostgreSQL promotion tests**
...
- [x] **Step 2: Implement target port**
...
- [x] **Step 3: Enforce ledger semantics**
...
- [x] **Step 4: Verify after writes before commit**
...
- [x] **Step 5: Run promotion integration tests**
...
- [x] **Step 2: Implement rebuild service**
...
- [x] **Step 3: Compose importer program**
...
- [x] **Step 4: Export importer API without startup coupling**
...
- [x] **Step 5: Run complete fixture tests**
