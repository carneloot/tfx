...
- [x] **Step 1: Write failing type fixtures**
...
- [x] **Step 2: Implement `MessageInput`**
...
- [x] **Step 3: Implement declaration/result values**
...
- [x] **Step 1: Write failing group/builder tests**
...
- [x] **Step 3: Extend `Bot` validation**
...
- [x] **Step 6: Commit builder support**
...
- [x] **Step 1: Write failing routing-order tests**
...
- [x] **Step 2: Implement registry dispatch**
...
- [x] **Step 3: Infer polling update kinds**
...
- [x] **Step 4: Export public modules**
...
- [x] **Step 1: Write failing migration and SQL/security tests**
...
- [x] **Step 2: Add reply-operation migration**
...
- [x] **Step 4: Implement `CorrectFoodBySource`**
...
- [x] **Step 5: Add replay ledger to route transaction**
...
- [x] **Step 6: Run SQL/application tests**
...
- [x] **Step 7: Commit source correction**
...
- [x] **Step 2: Implement fixed precedence**
...
- [x] **Step 3: Add food from reminder**
...
- [x] **Step 1: Add declaration before implementation**
...
- [x] **Step 2: Implement handler output**
...
- [x] **Step 3: Bind group and router**
...
- [x] **Step 4: Run app unit/type tests**
...
- [x] **Step 1: Add real-PostgreSQL scenarios**
...
- [x] **Step 2: Add collision/precedence scenarios**
...
- [x] **Step 3: Add duplicate update/output-failure scenarios**
...
- [x] **Step 4: Run E2E and package gates**
