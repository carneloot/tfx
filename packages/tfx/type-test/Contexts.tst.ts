...
const messageContext: MessageContext.MessageContextService = MessageContext.make(message)
const callbackContext: CallbackQueryContext.CallbackQueryContextService = CallbackQueryContext.make(callbackQuery)
void messageContext
