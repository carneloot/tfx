...
export const choice = <A, R>(value: ConversationChoice.Choice<A, R>): ConversationInput<ConversationChoice.ChoiceResult<A>, R, CallbackQueryContext | MessageContext> & { readonly choice: ConversationChoice.Choice<A, R> } => Object.freeze({ _tag: "Callback", choice: value, _A: undefined as never, _R: undefined as never, _Context: undefined as never })
